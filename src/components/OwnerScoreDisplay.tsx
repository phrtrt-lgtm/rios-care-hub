    ...
    return (
      <Card className="bg-gradient-to-br from-primary/5 via-background to-primary/10 border-primary/20 overflow-hidden">
        ...
        <CardContent className="space-y-3">
          ...
          {/* Collapsible info - destacado para novos usuários */}
          <Collapsible open={showInfo} onOpenChange={setShowInfo}>
            <CollapsibleTrigger asChild>
              <button className="w-full bg-amber-500/10 border border-amber-500/20 rounded-lg p-3 text-left hover:bg-amber-500/15 transition-colors">
                <div className="flex items-center justify-between">
                  <p className="text-sm font-medium text-amber-600 flex items-center gap-2">
                    <Info className="h-4 w-4" />
                    Importante: entenda como funciona o score
                  </p>
                  {showInfo ? (
                ...
                {!showInfo && (
                  <p className="text-xs text-muted-foreground mt-1">
                    Clique para ver como ganhar pontos e economizar nas manutenções
                  </p>
                )}
              </button>
            </CollapsibleTrigger>
            <CollapsibleContent>
              <div className="mt-3 space-y-4 bg-muted/30 rounded-lg p-4">
