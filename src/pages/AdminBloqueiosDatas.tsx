                ...
                <Card key={req.id} className="overflow-hidden">
                  <CardContent className="p-0">
                    <div className="flex gap-0">
                      {/* Color bar */}
                      <div className={`w-1 shrink-0 ${req.status === "pending" ? "bg-amber-400" : req.status === "processed" ? "bg-green-500" : "bg-red-400"}`} />
                      ...
                      <div className="flex-1 p-4">
                        <div className="flex items-start justify-between gap-3">
                          <div className="space-y-2 flex-1 min-w-0">
                            ...
                            {/* Reason + badges */}
                            <div className="flex items-center gap-2 flex-wrap">
                              <div className={`flex items-center gap-1 text-xs font-medium ${reasonConfig[req.reason].color}`}>
                                <ReasonIcon className="h-3 w-3" />
                                {reasonConfig[req.reason].label}
                              </div>
