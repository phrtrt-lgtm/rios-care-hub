...
DROP POLICY IF EXISTS "tm_admin_all" ON ticket_messages;
DROP POLICY IF EXISTS "tm_agent_all" ON ticket_messages;
DROP POLICY IF EXISTS "tm_owner_access" ON ticket_messages;
DROP POLICY IF EXISTS "ta_admin_all" ON ticket_attachments;
DROP POLICY IF EXISTS "ta_agent_all" ON ticket_attachments;
DROP POLICY IF EXISTS "ta_owner_access" ON ticket_attachments;
